...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        // 输入安全密码的背景View
        UIView *BGView = [[UIView alloc] initWithFrame:CGRectMake((HB_ScreenW * 0.15 ) / 2, 0, HB_ScreenW * 0.85, 200)];
        ...
        // 密码框
        CGFloat passwordTextFieldY = (BGViewH - CGRectGetMaxY(topLineView.frame) - kButtonHeight - kBorderHeight - 30) / 2;
        ...
        for (NSInteger i = 0; i < kPasswordCount; i++) {
            ...
            pointView.layer.cornerRadius = pointView.frame.size.height / 2.0;
...
//
        ...
        sureBtn.enabled=YES;
         [sureBtn setTitleColor:[UIColor colorWithRed:51/255.0 green:140/255.0 blue:232/255.0 alpha:1] forState:UIControlStateNormal];
